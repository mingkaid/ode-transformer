...
"""
Transformer by the architecture specified in Vaswani et al. (2017), with normalizing after each sublayer, as opposed to before in the Harvard implementation
"""
